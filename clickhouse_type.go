...
func (a *Clickhouse) Type(t *Field) string {
	if t.Clickhouse.IP {
		return t.Clickhouse.Type
	}
	...
	if strings.EqualFold(t.Name, "ip") || strings.EqualFold(t.Clickhouse.Name, "ip") {
		t.Clickhouse.IP = true
		return "IPv4"
	}
